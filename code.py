...
def extractKeypoint(path):
    ...
    # Initialize default values for angles and keypoints
    angle1 = angle2 = angle3 = angle4 = angle5 = angle6 = angle7 = angle8 = 0
    keypoints = []  # Initialize keypoints as an empty list
    ...
    return landmarks, keypoints, [angle1, angle2, angle3, angle4, angle5, angle6, angle7, angle8], image
...
x = extractKeypoint("yoga25.jpg")
cv2.imshow('MediaPipe Feed', x[3])
cv2.waitKey(0)
cv2.destroyAllWindows()
y = extractKeypoint("yoga22.jpg")
